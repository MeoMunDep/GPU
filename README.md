...
- Run the following command to clone the repository:
  ...
  ```bash
  git clone https://github.com/MeoMunDep/gpu.git
  ```
...
```bash
sudo npm install --force user-agents axios meo-forkcy-colors https-proxy-agent socks-proxy-agent ethers web3 crypto-js
```
...
### 2.1 `new_privateKeys.txt` - Is for new wallets that you created
...
- **Support me via** [Referral Link](https://token.gpu.net?ref=BYPU1B)
